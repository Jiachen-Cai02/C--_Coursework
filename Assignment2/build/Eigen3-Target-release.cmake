...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT Eigen3::Eigen #############
        ...
        set_property(TARGET Eigen3::Eigen PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${eigen_Eigen3_Eigen_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Eigen3::Eigen PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${eigen_Eigen3_Eigen_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Eigen3::Eigen PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${eigen_Eigen3_Eigen_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Eigen3::Eigen PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${eigen_Eigen3_Eigen_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Eigen3::Eigen PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${eigen_Eigen3_Eigen_COMPILE_OPTIONS_RELEASE}> APPEND)
